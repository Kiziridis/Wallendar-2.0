 ...
 */
module.exports.addCard = function addCard(_req, res, __, body, walletId) {
 ...
 */
module.exports.removeCard = function removeCard(_req, res, __, walletId, cardNumber) {
 ...
 */
module.exports.useCard = function useCard(_req, res, __, body, walletId) {
 ...
 */
module.exports.viewCards = function viewCards(_req, res, __, walletId) {
