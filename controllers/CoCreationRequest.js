...
module.exports.coCreation = function coCreation (_req, res, _, body, suggestedTimeslot, coCreationId) {
...
module.exports.receiveCoCreationRequest = function receiveCoCreationRequest (_req, res, _, senderId, coCreationId) {
...
module.exports.sendCoCreationRequest = function sendCoCreationRequest (_req, res, _, body, receiverIds) {
